...
var incompleteTaskHolder=document.getElementById("uncompleted");//ul of #uncompleteTasks
...
var createNewTaskElement=function(taskString){
  ...
  checkBox.setAttribute("id", "make-done");
  editInput.setAttribute("id", "added");
...
//Select ListItems children
  var checkBox=taskListItem.querySelector("#make-done");
